...
teta_hbot       = fnteta( W.hbot,  P.sh, W.nz );
teta_hsurf      = fnteta( W.hsurf, P.sh, 1    );
    
if or(P.sh.ifc==1,P.sh.ifc==3)
    kp(W.nz,1)  = ( P.kond(W.nz,P.j) + fncond(teta_hbot, P.sh,W.nz) )/2;
    km(1,1)     = ( P.kond(1,P.j)    + fncond(teta_hsurf,P.sh,1   ) )/2;
else
    kp(W.nz,1)  = ( P.kond(W.nz,P.j) + fncond(W.hbot,P.sh,W.nz    ) )/2;
...
%% bottom node flux
ratio(W.nz,1)   = 2*W.dtin/(P.nodes.dz(W.nz+1)*P.nodes.dz(W.nz));
alfa(W.nz,1)    = -ratio(W.nz)*km(W.nz);
gamma(W.nz,1)   = 0;
if W.ibbc==0
   beta(W.nz,1) = P.cap(W.nz,P.j) + ratio(W.nz)*km(W.nz);
   delta(W.nz,1)= P.cap(W.nz,P.j)*P.h1(W.nz,P.j) + ...
                  P.nodes.dz(W.nz)*ratio(W.nz)*(km(W.nz)+W.qbot) - ...
                  W.dtin*P.sink(W.nz,P.j);
else
   beta(W.nz,1) = P.cap(W.nz,P.j) + ratio(W.nz)*km(W.nz) + ...
                  ratio(W.nz)*kp(W.nz);
   delta(W.nz,1)= P.cap(W.nz,P.j)*P.h1(W.nz,P.j) + ...
                  P.nodes.dz(W.nz)*ratio(W.nz)*(km(W.nz)-kp(W.nz)) + ...
