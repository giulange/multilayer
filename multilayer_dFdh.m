...
%% PRE
dz              = P.nodes.dz;
% disnod          = P.nodes.disnod;
hgrad(1)        = (hsurf-P.h(1))/P.nodes.disnod(1) +1;
...
dF_dh(1,1)  = dz(1)/P.dt*Ci(1)*P.FrArMtrx(1) + dz(1)*dSINKmacr_dh(1) + ...
            + P.Kip2(1)/P.nodes.disnod(2) + ...
            + P.Kim2(1)/P.nodes.disnod(1) * (~isflux) + ...% HEAD controlled top boundary
...
dF_dh(IDX)  = dz(2:P.nz-1)/P.dt.*Ci(2:P.nz-1).*P.FrArMtrx(2:P.nz-1) + ...
            ...
            + P.Kim2(2:P.nz-1)./P.nodes.disnod(2:P.nz-1)    + ...
            + P.Kip2(2:P.nz-1)./P.nodes.disnod(3:P.nz-0)    + ...
...
switch W.SwBotB
    ...
    case 7% FREE DRAINAGE
        dF_dh(P.nz,P.nz) = dz(P.nz)/P.dt.*Ci(P.nz)*P.FrArMtrx(P.nz) + ...
                         ...
                         + P.Kim2(P.nz)./P.nodes.disnod(P.nz) + ...
