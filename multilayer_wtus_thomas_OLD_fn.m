...
for i=1:P.nz
    % Ritenzione:
    P.teta(i)               = fnteta_OLD(P.h_jm1(i), P.sh.tetas(i),P.sh.tetar(i),P.sh.alfrs(i),P.sh.fi(i),P.sh.alfvg(i),P.sh.en(i),P.sh.alfvg2(i),P.sh.en2(i),P.sh.ifr(i));
%     P.teta(i)               = fnteta( P.h_jm1, P.sh, i );
    % Conducibilità:
    if P.sh.ifc(i)==1 || P.sh.ifc(i)==3
        P.K(i)           = fncond_OLD(P.teta(i),P.sh.tetas(i),P.sh.tetar(i),P.sh.alfrs(i),P.sh.fi(i),P.sh.alfvg(i),P.sh.en(i),P.sh.alfvg2(i),P.sh.en2(i),P.sh.k0(i),P.sh.k0macr(i),P.sh.bita(i),P.sh.bita2(i),P.sh.ifc(i));
%         P.K(i)           = multilayer_conductivity_node( P.teta,  P.sh, i );
%         kond(i)             = multilayer_conductivity_node( P.teta,  P.sh, i );
    else
        P.K(i)           = fncond_OLD(P.h_jm1(i),P.sh.tetas(i),P.sh.tetar(i),P.sh.alfrs(i),P.sh.fi(i),P.sh.alfvg(i),P.sh.en(i),P.sh.alfvg2(i),P.sh.en2(i),P.sh.k0(i),P.sh.k0macr(i),P.sh.bita(i),P.sh.bita2(i),P.sh.ifc(i));
%         P.K(i)           = multilayer_conductivity_node( P.h_jm1,  P.sh, i );
    end
    % Capacità:
    P.cap(i)                = fncap_OLD(P.h_jm1(i),P.sh.tetas(i),P.sh.tetar(i),P.sh.alfrs(i),P.sh.fi(i),P.sh.alfvg(i),P.sh.en(i),P.sh.alfvg2(i),P.sh.en2(i),P.sh.ifr(i));
...
%                 P.sink(i)   = fnsink( P.h_jm1(i), P, W, V );
                P.sink(i)   = fnsink_OLD(P.h_jm1(i),P.dpt,P.op,P.Tp,V.hI,V.hII,V.hIIIH,V.hIIIL,V.hIV,V.hw50,V.pw1,V.hs50,V.ps1,V.aMH,V.bMH,P.Droot(P.tidx),V.ifs,V.rda,V.rdb,V.rdc,P.nz,V.ifg,V.zc,V.g0,V.gzc,V.Drf);
            else
                P.sink(i)   = 0;
            end
        else
...
% figure(37),plot([kond',P.K]),title('kond'),legend('NEW','OLD')
%% FLUX :: TOP boundary
...
%                                 P.K(1), W.Kmeth );
            ...
            P.Emax          = -P.km(P.j) * ((W.hsurf-P.h_jm1(1))/P.nodes.disnod(1)+1);
...
%                                 multilayer_conductivity_internode( P.K(P.nz), ...
...
P.q(P.nz)       = -P.K(P.nz) * ( (P.h_jm1(P.nz-1)-W.hbot)/P.nodes.disnod(P.nz+1) +1);

P.q(2:P.nz-1)   = -P.K(2:P.nz-1).* ...
                 (  (P.h_jm1(1:P.nz-2)-P.h_jm1(3:P.nz)) ./ ...
                    (P.nodes.dz(2:P.nz-1)+0.5*P.nodes.dz(1:P.nz-2)+0.5*P.nodes.dz(3:P.nz)) + ... % equal to :: P.nodes.dz(2)+sum(P.nodes.dz([1,3]))*0.5
              +1 );
% -P.K(2:P.nz-1).*( ( P.h_jm1(1:P.nz-2)-P.h_jm1(3:P.nz) ) ./ (2*P.nodes.dz(2:P.nz-1))+1 );
...
P.h = [fnsyst_OLD(1,P.dt,P.nodes.dz,P.nodes.dz(P.nz+1),P.nz,W.hbot,W.hsurf,W.qsurf,W.qbot,W.itbc,W.ibbc,P.h_jm1,P.teta,P.K,P.cap,P.sink,P.sh.tetas,P.sh.tetar,P.sh.alfrs,P.sh.fi,P.sh.alfvg,P.sh.en,P.sh.alfvg2,P.sh.en2,P.sh.ifr,P.sh.k0,P.sh.k0macr,P.sh.bita,P.sh.bita2,P.sh.ifc)]';
%% calcolo capacita' metodo implicito (vedi Karvonen) -- capacità 1/2
for i=1:P.nz
    if abs(P.h(i)-P.h_jm1(i))>W.tolle1
        P.cap(i)            = ( ...
                            fnteta_OLD(P.h(i), P.sh.tetas(i),P.sh.tetar(i),P.sh.alfrs(i),P.sh.fi(i),P.sh.alfvg(i),P.sh.en(i),P.sh.alfvg2(i),P.sh.en2(i),P.sh.ifr(i))...
                          - fnteta_OLD(P.h_jm1(i), P.sh.tetas(i),P.sh.tetar(i),P.sh.alfrs(i),P.sh.fi(i),P.sh.alfvg(i),P.sh.en(i),P.sh.alfvg2(i),P.sh.en2(i),P.sh.ifr(i))...
                          ) / ( P.h(i)-P.h_jm1(i) );
%                             fnteta(P.h,P.sh,i) ...
%                           - fnteta(P.h_jm1,P.sh,i) ...
    end
end
% fnsyst con il nuovo P.cap:
% O.h22(:,P.j,mm)             = fnsyst( P, W );
O.h22(:,P.j,mm) = fnsyst_OLD(1,P.dt,P.nodes.dz,P.nodes.dz(P.nz+1),P.nz,W.hbot,W.hsurf,W.qsurf,W.qbot,W.itbc,W.ibbc,P.h_jm1,P.teta,P.K,P.cap,P.sink,P.sh.tetas,P.sh.tetar,P.sh.alfrs,P.sh.fi,P.sh.alfvg,P.sh.en,P.sh.alfvg2,P.sh.en2,P.sh.ifr,P.sh.k0,P.sh.k0macr,P.sh.bita,P.sh.bita2,P.sh.ifc);
