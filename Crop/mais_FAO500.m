...
V.description       = { 
    ...
    '106-120 days';
    'FAO class 500'
    'Source: "Disciplinari di produzione integrata", 2014, Regione Campania'};
%% (01) PLANT GROWTH
...
%                   The following list comes from Giovanna's table.
% *                     DVS     LAI/SCF
V.LAI               = [
                        0.013   0.01
                        0.260   0.07
...
%                   ----------------------------------------
% 
% #1 :: swDroot     The following three parameters are used to calculate
...
% -------------------------------------------------------------------------
% soil water extraction by plant roots: prendere da tabella di SWAP
...
%                        1: discrete irrigation dates with iDEPTH volumes
%                        2: discrete irrigation dates with h_to thresholds
...
%   [sdate,edate]   [0,100] [0,1d03]    [0,3]   [0,200] [-1000,0]   [-500,0]  
    '04-01'         NaN     0           1       NaN     -350        -0
    '05-01'         NaN     0           1       NaN     -475        -10
    '06-01'         NaN     0           1       NaN     -700        -20
                      };
%                   -----------------------------------
