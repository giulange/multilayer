...
text(X(1),2,{'Depth';'[cm]'},'HorizontalAlignment','right','VerticalAlignment','bottom')
...
text(X(2)+1.5,2,'nodes','HorizontalAlignment','left','VerticalAlignment','cap','rotation',90)
text(X(2)+3.5,2,{'Z';'[cm]'},'HorizontalAlignment','left','VerticalAlignment','bottom','Color','y')

axis([ X(1), X(2)+8, -Wzint(end), Wzint(1) ]+offset)
hold off
axis off
